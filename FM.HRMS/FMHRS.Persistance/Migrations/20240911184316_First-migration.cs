...
namespace FMHRS.Persistance.Migrations
{
    /// <inheritdoc />
    public partial class Firstmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CompanyCIN = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentCompanyName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Applicant_JobPositions_JobId",
                        column: x => x.JobId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Round_JobPositions_JobId",
                        column: x => x.JobId,
                        principalTable: "JobPositions",
                        principalColumn: "JobId",
                        onDelete: ReferentialAction.Cascade);
